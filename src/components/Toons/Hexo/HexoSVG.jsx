...
export default function HexoSVG({ ref }) {
  return (
    <svg
      ref={ref}
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 100 100"
      aria-labelledby="HexoTitle HexoDesc"
    >
      <g className="Hexo-Hexo">
        <g className="Hexo-body">
          <path
            className="Hexo-r-arm"
            fill="none"
            stroke="#9FD4E5"
            strokeLinecap="round"
